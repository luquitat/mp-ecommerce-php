...
<div class="stack">
    ...
    <div class="as-search-wrapper" role="main">
        ...
        <div class="as-search-results as-filter-open as-category-landing as-desktop" id="as-search-results">
            <?php
            if($_GET['respuesta'] == 'success'){
                echo("<h1>SALIO TODO CORRECTO</h1>");
                echo("<h2>Monto: 123121</h2>");
                echo("<h2>Id de pago: ".$_GET['collection_id']."</h2>");
            }
            if($_GET['respuesta'] == 'failure'){
                echo("<h1>SALIO TODO MAL, SU PAGO NO FUE PROCESADO</h1>");
            }
            if($_GET['respuesta'] == 'pending'){
                echo("<h1>Estamos esperando tu pago</h1>");
            }
            ?>
        </div>
    </div>
